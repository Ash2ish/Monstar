...
class NavBar(tk.Menu):
    def __init__(self, parent):
        ...
        menu_file.add_command(label="How to use Monster", command=parent.OpenHelpPage)
...
class MainPage(tk.Frame):
    def __init__(self, parent):
        ...
        label_header = tk.Label(parent, text="Monster", font=("Verdana Pro Cond Black", 25))
        label_header.place(rely=0.03, relx=0.02)
        label_author = tk.Label(parent, text="by Ashish kumar", font=MAIN_FONT)
...
class HelpPage(BaseWindow):
    def __init__(self):
        ...
        frame_about = tk.LabelFrame(self.base_frame, text="About Monster")
...
class DisclaimerPage(BaseWindow):
    def __init__(self):
        ...
        frame_disc = tk.LabelFrame(self.base_frame, text="Monster Disclaimer")
